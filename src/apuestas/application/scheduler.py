...
from apuestas.application.betplay import BetplayService
from apuestas.application.football_api import FootballDataService, H2HService
from apuestas.entrypoints import train as train_xgboost
from apuestas.infrastructure.persistence import LeaguesConfigRepository
from apuestas.ml.xgboost import predictor as xgboost_predictor
...
def run_betplay() -> None:
    ...
    try:
        ...
        for league in leagues:
            ...
            xgboost_predictor.run(league["league_db"], H2HService(league["league_db"]))
